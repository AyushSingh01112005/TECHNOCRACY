export default function SpiderCrawler2() {
  return (
    <div className="spider-crawler">
      <svg viewBox="0 0 160 160" xmlns="http://www.w3.org/2000/svg">
        <defs>
          {/* ── Lighter Exoskeleton Materials ── */}
          <radialGradient id="abdomenShell" cx="30%" cy="25%" r="75%">
            <stop offset="0%" stopColor="#4a2222" />
            <stop offset="25%" stopColor="#2d1111" />
            <stop offset="65%" stopColor="#180909" />
            <stop offset="92%" stopColor="#0e0505" />
            <stop offset="100%" stopColor="#090303" />
          </radialGradient>

          <radialGradient id="carapaceShell" cx="35%" cy="30%" r="65%">
            <stop offset="0%" stopColor="#633030" />
            <stop offset="40%" stopColor="#321515" />
            <stop offset="80%" stopColor="#1b0808" />
            <stop offset="100%" stopColor="#0c0404" />
          </radialGradient>

          <linearGradient id="legSeg" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#3b1818" />
            <stop offset="40%" stopColor="#241010" />
            <stop offset="100%" stopColor="#100606" />
          </linearGradient>
          ...
          <radialGradient id="eyeLens" cx="35%" cy="30%" r="65%">
            ...
            <stop offset="100%" stopColor="#160505" />
          </radialGradient>
        ...
        <g className="leg-group gait-2-left pivot-left-rear">
          ...
          <circle cx="30" cy="64" r="3.2" fill="#180909" />
          <circle cx="4" cy="50" r="2.2" fill="#180909" />

          <path
            d="M24 62 L20 58 M18 60 L14 56 M10 56 L7 52 M32 66 L28 62"
            stroke="#4a1c1c"
            strokeWidth="0.7"
            opacity="0.65"
          />
        ...
        <g className="leg-group gait-1-right pivot-right-rear">
          ...
          <circle cx="130" cy="64" r="3.2" fill="#180909" />
          <circle cx="156" cy="50" r="2.2" fill="#180909" />

          <path
            d="M136 62 L140 58 M142 60 L146 56 M150 56 L153 52 M128 66 L132 62"
            stroke="#4a1c1c"
            strokeWidth="0.7"
            opacity="0.65"
          />
        ...
        <g className="leg-group gait-1-left pivot-left-mid1">
          ...
          <circle cx="26" cy="80" r="3.2" fill="#180909" />
          <circle cx="2" cy="70" r="2.2" fill="#180909" />

          <path
            d="M20 78 L16 74 M12 76 L8 72 M6 72 L3 68"
            stroke="#4a1c1c"
            strokeWidth="0.7"
            opacity="0.65"
          />
        ...
        <g className="leg-group gait-2-right pivot-right-mid1">
          ...
          <circle cx="134" cy="80" r="3.2" fill="#180909" />
          <circle cx="158" cy="70" r="2.2" fill="#180909" />

          <path
            d="M140 78 L144 74 M148 76 L152 72 M154 72 L157 68"
            stroke="#4a1c1c"
            strokeWidth="0.7"
            opacity="0.65"
          />
        ...
        <g className="leg-group gait-2-left pivot-left-mid2">
          ...
          <circle cx="28" cy="104" r="3.2" fill="#180909" />
          <circle cx="8" cy="122" r="2.2" fill="#180909" />

          <path
            d="M22 106 L18 110 M16 108 L12 114 M10 118 L7 124"
            stroke="#4a1c1c"
            strokeWidth="0.7"
            opacity="0.65"
          />
        ...
        <g className="leg-group gait-1-right pivot-right-mid2">
          ...
          <circle cx="132" cy="104" r="3.2" fill="#180909" />
          <circle cx="152" cy="122" r="2.2" fill="#180909" />

          <path
            d="M138 106 L142 110 M144 108 L148 114 M150 118 L153 124"
            stroke="#4a1c1c"
            strokeWidth="0.7"
            opacity="0.65"
          />
        ...
        <g className="leg-group gait-1-left pivot-left-front">
          ...
          <circle cx="42" cy="116" r="3.2" fill="#180909" />
          <circle cx="28" cy="136" r="2.2" fill="#180909" />

          <path
            d="M36 114 L32 118 M34 120 L30 126 M30 130 L27 136"
            stroke="#4a1c1c"
            strokeWidth="0.7"
            opacity="0.65"
          />
        ...
        <g className="leg-group gait-2-right pivot-right-front">
          ...
          <circle cx="118" cy="116" r="3.2" fill="#180909" />
          <circle cx="132" cy="136" r="2.2" fill="#180909" />

          <path
            d="M124 114 L128 118 M126 120 L130 126 M130 130 L133 136"
            stroke="#4a1c1c"
            strokeWidth="0.7"
            opacity="0.65"
          />
        ...
        <g className="spider-body">
          ...
          <path
            d="M80 78 L78 84 L80 88 L82 84 Z"
            fill="#991b1b"
            opacity="0.5"
          />

          <path
            d="M80 92 L77 98 L80 102 L83 98 Z"
            fill="#991b1b"
            opacity="0.4"
          />

          <path
            d="M56 96 Q80 102 104 96"
            stroke="#080202"
            strokeWidth="1"
            fill="none"
            opacity="0.4"
          ...
          <path
            ...
            fill="url(#carapaceShell)"
            filter="url(#softShadow)"
          />

          <path
            d="M80 42 C70 42, 64 48, 64 56 C64 62, 68 66, 74 68 C68 62, 66 54, 70 48 C74 44, 78 42, 80 42 Z"
            fill="url(#specular)"
            opacity="0.9"
          />

          <path
            d="M78 52 Q80 54 82 52"
            stroke="#080202"
            strokeWidth="1"
            fill="none"
            opacity="0.5"
          ...
          {/* EYES */}
          <circle cx="76" cy="46" r="3.5" fill="#080202" />
          <circle cx="76" cy="45" r="1.4" fill="url(#eyeLens)" />
          <circle cx="75.3" cy="44.3" r="0.5" fill="#ffffff" opacity="0.9" />

          <circle cx="84" cy="46" r="3.5" fill="#080202" />
          <circle cx="84" cy="45" r="1.4" fill="url(#eyeLens)" />
          <circle cx="83.3" cy="44.3" r="0.5" fill="#ffffff" opacity="0.9" />

          <circle cx="69" cy="48" r="2.4" fill="#080202" />
          <circle cx="69" cy="47.3" r="0.9" fill="#991b1b" />
          <circle cx="68.5" cy="46.8" r="0.35" fill="#ffffff" opacity="0.7" />

          <circle cx="91" cy="48" r="2.4" fill="#080202" />
          <circle cx="91" cy="47.3" r="0.9" fill="#991b1b" />
          <circle cx="90.5" cy="46.8" r="0.35" fill="#ffffff" opacity="0.7" />

          <circle cx="74" cy="52" r="2" fill="#080202" />
          <circle cx="74" cy="51.4" r="0.7" fill="#b91c1c" />

          <circle cx="86" cy="52" r="2" fill="#080202" />
          <circle cx="86" cy="51.4" r="0.7" fill="#b91c1c" />

          <circle cx="67" cy="54" r="1.6" fill="#080202" />
          <circle cx="67" cy="53.5" r="0.5" fill="#7f1d1d" />

          <circle cx="93" cy="54" r="1.6" fill="#080202" />
          <circle cx="93" cy="53.5" r="0.5" fill="#7f1d1d" />
          ...
          {/* SPINNERETS */}
          <ellipse cx="75" cy="142" rx="3" ry="5" fill="#180909" />
          <ellipse cx="85" cy="142" rx="3" ry="5" fill="#180909" />
          <ellipse cx="80" cy="145" rx="2.5" ry="4" fill="#0c0404" />

          <path
            d="M75 146 Q73 152 74 158"
            stroke="#ffffff"
            strokeWidth="0.5"
            opacity="0.2"
            fill="none"
